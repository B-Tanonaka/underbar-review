(function() {
  ...
  describe('Part I', function() {
    ...
    describe('reduce', function() {
      ...
      it('should return the result of multiplying all the elements of the array and the initial value ', function() {
        var result = _.reduce([1, 2, 3], function(memo, item) {
          return memo * item;
        }, 0);
      ...
      it('should pass the first item of the array into the iterator first if a memo is not passed in', function() {
